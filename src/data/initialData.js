...
export const INITIAL_PRODUCTS = [
  ...
  {
    id: 'prod-3',
    name: 'Xiaomi 14 Pro 12GB / 512GB Leica Optics Black',
    category: 'smartphones',
    price: 9800000,
    oldPrice: 11000000,
    discount: 11,
    ...
    gallery: ['https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=800&auto=format&fit=crop&q=80'],
    description: "Leica professional linzalari, 120W giper zaryadlash va Snapdragon 8 Gen 3 protsessoriga ega flagman.",
    specs: {
      "Ekran": "6.73 dyuym AMOLED LTPO, 3000 nit",
      "Protsessor": "Snapdragon 8 Gen 3",
      "Zaryad": "120W (18 daqiqada 100%)",
      "Kamera": "50MP Leica Variable Aperture"
    },
    reviews: []
  },
  {
    ...
    description: "Google Tensor G3 chipi, toza Android tajribasi va dunyodagi eng ilg'or mobil hisoblash fotografiyasi.",
    specs: {
      "Ekran": "6.7 dyuym Super Actua display, 120Hz",
      "Protsessor": "Google Tensor G3",
      "Kamera": "50MP + 48MP + 48MP (5x Zoom)",
      "Yillik yangilanish": "7 yil rasmiy Android yangilanishi"
    },
    reviews: []
  },
  ...
  // --- NOUTBUKLAR VA KOMPYUTERLAR ---
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=800&auto=format&fit=crop&q=80'],
  ...
  },
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?w=800&auto=format&fit=crop&q=80'],
    description: "Professional 3D render, video montaj va murakkab dasturlash loyihalari uchun mo'ljallangan qudratli noutbuk.",
    specs: {
      "Ekran": "16.2 dyuym Liquid Retina XDR (120Hz ProMotion)",
      "Protsessor": "Apple M3 Max (14-core CPU, 30-core GPU)",
      "Xotira": "36GB RAM, 1TB Superfast SSD",
  ...
  {
    id: 'prod-7',
    name: 'ASUS ROG Zephyrus G16 OLED Core Ultra 9 / RTX 4070',
    category: 'laptops',
    price: 24500000,
    oldPrice: 26900000,
    discount: 9,
    ...
    gallery: ['https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=800&auto=format&fit=crop&q=80'],
    description: "2.5K 240Hz ROG Nebula OLED displeyli, alyuminiy korpusli va RTX 4070 grafikali eng yupqa geyming noutbuki.",
    specs: {
      "Ekran": "16 dyuym 2.5K OLED, 240Hz, 0.2ms",
      "Protsessor": "Intel Core Ultra 9 185H",
      "Videokarta": "NVIDIA GeForce RTX 4070 8GB GDDR6",
  ...
  // --- MAISHIY TEXNIKA ---
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=800&auto=format&fit=crop&q=80'],
  ...
  {
    id: 'prod-9',
    name: 'Samsung EcoBubble 8kg Kir yuvish mashinasi Inverter',
    category: 'appliances',
    price: 5400000,
    oldPrice: 6200000,
    discount: 13,
    ...
    gallery: ['https://images.unsplash.com/photo-1626806787461-102c1bfaaea1?w=800&auto=format&fit=crop&q=80'],
    description: "EcoBubble ko'pik generatori bilan past haroratda ham kiyimlarni chuqur tozalaydi. 10 yil motor kafolati.",
    specs: {
      "Sig'imi": "8 kg",
      "Aylanish tezligi": "1400 ayl/daq",
      "Dvigatel": "Digital Inverter (10 yil kafolat)",
      "Bug' bilan tozalash": "Hygiene Steam allergiyaga qarshi"
    },
    reviews: []
  },
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1517668808822-9ebb02f2a0e6?w=800&auto=format&fit=crop&q=80'],
  ...
  {
    id: 'prod-11',
    name: 'Xiaomi Robot Vacuum S10+ Namlab tozalovchi changyutkich',
    category: 'appliances',
    price: 3450000,
    oldPrice: 3900000,
    discount: 12,
    ...
    gallery: ['https://images.unsplash.com/photo-1589824783837-6169889fa20f?w=800&auto=format&fit=crop&q=80'],
    description: "4000Pa kuchli tortish kuchi, 3D to'siqlarni aylanib o'tish datchigi va aylanuvchi nam lattalar bilan to'liq avtomat tozalash.",
    specs: {
      "Tortish kuchi": "4000 Pa",
      "Navigatsiya": "LDS Lazer + 3D Sensor",
      "Batareya": "5200 mAh (200 kv.m gacha)",
      "Boshqaruv": "Mi Home ilovasi (O'zbekcha xaritani qo'llab-quvvatlaydi)"
    },
    reviews: []
  },
  ...
  // --- KIYIM-KECHAK VA POYABZAL ---
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800&auto=format&fit=crop&q=80'],
  ...
  },
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1552346154-21d32810aba3?w=800&auto=format&fit=crop&q=80'],
    description: "Afsonaviy qizil-oq-qora ranglar uyg'unligi, tabiiy charmdan ishlangan korpus va Air amortizatsiya tagligi.",
    specs: {
      "Material": "100% Tabiiy Charm",
      "O'lchamlar": "40, 41, 42, 43, 44",
      "Amortizatsiya": "Nike Encapsulated Air-Sole"
    },
    reviews: []
  },
  {
    id: 'prod-14',
    name: 'Erkaklar uchun Klassik Jun Kostyum-Shim (Slim Fit)',
    category: 'clothing',
    price: 1450000,
    oldPrice: 1800000,
    discount: 19,
    ...
    gallery: ['https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800&auto=format&fit=crop&q=80'],
    description: "Italiya matolaridan tayyorlangan, rasmiy uchrashuvlar va tantanalar uchun eng nafis klassik kostyum.",
    specs: {
      "Tarkibi": "70% Jun, 30% Viskoza",
      "Bichimi": "Slim Fit (Qomatga mos)",
      "Rang": "Antratsit / To'q kulrang"
    },
    reviews: []
  },
  ...
  {
    id: 'prod-16',
    name: 'Savdogarlar Ustozi — Ahmad Lutfiy Qozonchi',
    category: 'books',
    price: 65000,
    oldPrice: 80000,
    discount: 18,
    ...
    gallery: ['https://images.unsplash.com/photo-1512820790803-83ca734da794?w=800&auto=format&fit=crop&q=80'],
    description: "Hazrati Usmon ibn Affon (r.a.) ning ibratli hayoti, saxovati va halol tijorat qoidalari haqidagi ajoyib asar.",
    specs: {
  ...
  {
    id: 'prod-17',
    name: 'Diqqat: Chalg\'ituvchi dunyoda muvaffaqiyat sirlari — Kel Nyuport',
    category: 'books',
    price: 75000,
    oldPrice: 95000,
    discount: 21,
    ...
    gallery: ['https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=800&auto=format&fit=crop&q=80'],
    description: "Chuqur ishlash (Deep Work) san'ati, internet chalg'itishlaridan qutulish va yuqori unumdorlikka erishish qo'llanmasi.",
    specs: {
      "Muallif": "Kel Nyuport",
      "Sahifalar": "288 bet",
      "Til": "O'zbek tili"
  ...
  // --- GO'ZALLIK VA SALOMATLIK ---
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&auto=format&fit=crop&q=80'],
    ...
    specs: {
      "Quvvat": "1300 Vt",
      "Harorat nazorati": "Intelligent Heat Control",
  ...
  {
    id: 'prod-19',
    name: 'Dior Sauvage Parfum 100ml Erkaklar Parfyumi',
    category: 'beauty',
    price: 1850000,
    oldPrice: 2200000,
    discount: 16,
    ...
    description: "Frantsiya original parfyumi. Bergamot, vanil va yog'ochli kompozitsiyasi bilan 24 soatgacha mustahkam ifor taratadi.",
    specs: {
      "Hajmi": "100 ml",
      "Turi": "Parfum (Eng yuqori konsentratsiya)",
      "Ishlab chiqaruvchi": "Fransiya (Christian Dior)"
    },
    reviews: []
  },
  {
    id: 'prod-20',
    name: 'Oral-B iO Series 9 Aqlli Elektr Tish Cho\'tkasi',
    category: 'beauty',
    price: 2600000,
    oldPrice: 3100000,
    discount: 16,
    ...
    stock: 8,
    badge: 'Yangi',
    image: 'https://images.unsplash.com/photo-1559591937-e111a9544b6c?w=800&auto=format&fit=crop&q=80',
    gallery: ['https://images.unsplash.com/photo-1559591937-e111a9544b6c?w=800&auto=format&fit=crop&q=80'],
    description: "Sun'iy intellekt datchiklari, rangli interaktiv displey va magnitli mikro-vibratsiya texnologiyasi bilan 100% toza tishlar.",
    specs: {
      "Rejimlar": "7 xil tozalash rejimi",
      "Sensor": "Bosim o'lchovchi aqlli datchik",
      "Zaryadlash": "Magnitli tezkor zaryad (3 soatda to'ladi)"
    },
    reviews: []
  },

  // --- AKSESSUARLAR VA SOATLAR ---
  {
    id: 'prod-21',
  ...
  },
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=800&auto=format&fit=crop&q=80'],
    ...
    specs: {
      ...
      "Sensorlar": "EKG, Yurak urishi, Qondagi kislorod"
    },
    reviews: []
  },
  {
    ...
    description: "H2 chipi bilan 2 barobar kuchliroq shovqin so'ndirish, moslashuvchan audio va yangilangan USB-C g'ilof.",
    specs: {
      "Chip": "Apple H2",
      "Shovqin to'sish": "Active Noise Cancellation + Adaptive Audio",
      "Batareya": "G'ilof bilan 30 soatgacha"
    },
    reviews: []
  },
  {
    id: 'prod-24',
    name: 'Tissot PRX Powermatic 80 Avtomatik Shveytsariya Soati',
    category: 'accessories',
    price: 8900000,
    oldPrice: 9800000,
    discount: 9,
    ...
    description: "1978-yilgi retro dizayn, 80 soatlik quvvat zaxirasiga ega Shveytsariya avtomatik mexanizmi va safir oyna.",
    specs: {
      "Mexanizm": "Swiss Automatic Powermatic 80",
      "Oyna": "Tirilmaydigan sapfir shisha",
      "Suvga chidamlilik": "100 metr (10 Bar)",
      "Ishlab chiqarilgan": "Shveytsariya (Swiss Made)"
    },
    reviews: []
  }
];
...
export const INITIAL_ORDERS = [
  ...
  },
  {
    ...
    items: [
      { id: 'prod-21', name: 'Sony WH-1000XM5 Simsiz quloqchin', price: 4350000, quantity: 1, image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&auto=format&fit=crop&q=80' },
      { id: 'prod-15', name: 'Atom Odatlar — Jeyms Klir', price: 89000, quantity: 2, image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=800&auto=format&fit=crop&q=80' }
    ],
    deliveryType: 'standard',
    deliveryPrice: 35000,
    paymentMethod: 'Click',
  ...
  },
  {
    ...
    items: [
      { id: 'prod-12', name: 'Erkaklar uchun Premium Paxtali Klassik Kurtka', price: 650000, quantity: 1, image: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800&auto=format&fit=crop&q=80' }
    ],
